...
render "templatefile(\"$ROOT/bootstrap/control-plane.yaml\",{$COMMON,pod_cidr=\"10.244.0.0/16\",service_cidr=\"10.96.0.0/12\",api_target_group_arn=\"arn:aws:elasticloadbalancing:eu-west-1:111122223333:targetgroup/api/123\",kpr_gate_library=file(\"$ROOT/bootstrap/kpr-gate.sh\")})" "$TMP/founder.sh"
